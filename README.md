...
Below are examples of images generated by the Latent Diffusion Transformer model:

![Generated Image 1](./data/generated_image1.png)
![Generated Image 2](./data/generated_image2.png)

### Image-to-Image Diffusion

The model's ability to perform image-to-image diffusion is demonstrated below:

![Image-to-Image Diffusion](./data/image_to_image_diffusion.png)

### Square Mask Diffusion

The results of applying square mask diffusion are shown below:

![Square Mask Output 1](./data/square_mask_output_1.png)
![Square Mask Output 2](./data/square_mask_output_2.png)

### Smooth Mask Diffusion

The results of applying smooth mask diffusion are shown below:

![Smooth Mask Output](./data/smooth_mask_output.png)
